...
public class eletronico extends produto {
    ...
    public eletronico(String nome, double preco, int estoque, int garantia, fornecedor fornecedor) {
    ...
    public void calcularGarantiaRestante(int mesesDecorridos) {
        ...
        if (restante > 0) {
            ...
            System.out.println("O produto nao esta mais coberto pela garantia.");
        }
    }
